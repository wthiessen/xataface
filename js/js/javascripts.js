...
/*
function warehouse_req() {
	window.open("index.php?-table=inventoryreq&-action=new", '_blank','toolbar=no,scrollbars=yes,resizable=no,top=100,left=100,width=900,height=600'); return false;
	//document.getElementsByNames("-search").focus();
}
*/
